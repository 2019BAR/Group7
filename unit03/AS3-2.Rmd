...
<br><hr>
```{r}
IBMs = read.csv("data/IBMStock.csv")
GEs = read.csv("data/GEStock.csv")
PGs = read.csv("data/ProcterGambleStock.csv")
CCs = read.csv("data/CocaColaStock.csv")
BEs = read.csv("data/BoeingStock.csv")
...
```{r}
CCs$Date[which.max(CCs$StockPrice)]
CCs$Date[which.min(CCs$StockPrice)] 
#highest stock price-1/1/73
#lowest stock price-3/1/80
```
...
```{r}
BEs$Date = as.Date(BEs$Date, "%m/%d/%y")
CCs$Date = as.Date(CCs$Date, "%m/%d/%y")
GEs$Date = as.Date(GEs$Date, "%m/%d/%y")
IBMs$Date = as.Date(IBMs$Date, "%m/%d/%y")
PGs$Date = as.Date(PGs$Date, "%m/%d/%y")
```

```{r}
which(BEs$Date == "2000-03-01")
plot(BEs$Date[360:372], BEs$StockPrice[360:372], type = "l",col = "red", ylim = c(35,200))
lines(CCs$Date, CCs$StockPrice, col = "blue")
lines(GEs$Date, GEs$StockPrice, col = "green")
lines(IBMs$Date, IBMs$StockPrice, col = "yellow" )
lines(PGs$Date, PGs$StockPrice, col = "purple")
...
```{r}
which(CCs$Date == "1983-01-01 CST")
plot(CCs$Date[145:181], CCs$StockPrice[145:181], col = "red", type = "l")
lines(PGs$Date[145:181], PGs$StockPrice[145:181], col = "blue")
#Coca-Cola
#
```
...
plot(BEs$Date[360:390], BEs$StockPrice[360:390], type="l", col="red", ylim = c(35,200))
lines(CCs$Date, CCs$StockPrice, col="blue")
lines(GEs$Date, GEs$StockPrice, col="green")
lines(IBMs$Date, IBMs$StockPrice, col="yellow")
lines(PGs$Date, PGs$StockPrice, col="purple")
...
```{r}
which(BEs$Date == "1995-01-01")
which(BEs$Date == "2005-12-01")
```


```{r}
plot(BEs$Date[301:432], BEs$StockPrice[301:432], type="l", col="red", ylim = c(50,250))
lines(CCs$Date, CCs$StockPrice, col="blue")
lines(GEs$Date, GEs$StockPrice, col="green")
lines(IBMs$Date, IBMs$StockPrice, col="yellow")
lines(PGs$Date, PGs$StockPrice, col="purple")
...
```{r}
which(BEs$Date == "1997-09-01")
```

```{r}
plot(BEs$Date[325:339], BEs$StockPrice[325:339], type="l", col="red", ylim = c(0,250))
lines(CCs$Date, CCs$StockPrice, col="blue")
lines(GEs$Date, GEs$StockPrice, col="green")
lines(IBMs$Date, IBMs$StockPrice, col="yellow")
lines(PGs$Date, PGs$StockPrice, col="purple")
...
```{r}
plot(BEs$Date[400:432], BEs$StockPrice[400:432], type="l", col="red", ylim = c(0,250))
lines(CCs$Date, CCs$StockPrice, col="blue")
lines(GEs$Date, GEs$StockPrice, col="green")
lines(IBMs$Date, IBMs$StockPrice, col="yellow")
lines(PGs$Date, PGs$StockPrice, col="purple")
...
```{r}
mean(IBMs$StockPrice)
tapply(IBMs$StockPrice, format(IBMs$Date, "%m"), mean) %>% sort
#1月、2月、3月、4月、5月
#
```
...
```{r}
tapply(CCs$StockPrice, format(CCs$Date, "%m"), mean) %>% sort
tapply(GEs$StockPrice, format(GEs$Date, "%m"), mean) %>% sort
#4月
#
```
